...
function loadProductionEnv() {
  ...
  const possiblePaths = [
    ...
    join(__dirname, ".env.production"), // Same directory as this file
  ...
  // eslint-disable-next-line no-console
  console.log("[env-loader] No .env.production file found in any of the expected locations:", possiblePaths);
}
