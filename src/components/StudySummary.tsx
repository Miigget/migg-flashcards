          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              {againCount ? (
                <div>
                  <div className="flex justify-between mb-1">
                    <span className="text-sm font-medium text-red-600">Very Bad</span>
              ...
              {hardCount ? (
                <div>
                  <div className="flex justify-between mb-1">
                    <span className="text-sm font-medium text-orange-600">Bad</span>
                    <span className="text-sm text-muted-foreground">
              ...
              {goodCount ? (
                <div>
                  ...
                  <div className="w-full bg-muted rounded-full h-2">
                    <div className="bg-yellow-500 h-2 rounded-full" style={{ width: `${goodPercentage}%` }}></div>
                  </div>
                </div>
              ) : null}
              ...
              {easyCount ? (
                <div>
                  ...
                  <div className="w-full bg-muted rounded-full h-2">
                    <div className="bg-green-500 h-2 rounded-full" style={{ width: `${easyPercentage}%` }}></div>
                  </div>
                </div>
              ) : null}
            </div>
